        ...
        <div class="container mt-4">
            ...
            <div class="row mt-4 justify-content-center">
                <div class="col-md-3 mb-2">
                    <button @click="openModal('aluno')" class="btn btn-primary w-100" v-show="!modalShow">Cadastro de
                        Aluno</button>
                </div>
                <div class="col-md-3 mb-2">
                    <button @click="openModal('sala')" class="btn btn-primary w-100" v-show="!modalShow">Cadastro de
                        Sala</button>
                </div>
                <div class="col-md-3">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ modalType === 'aluno' ? 'Cadastro de Aluno' : 'Cadastro de Sala' }}
                            </h5>
...
<style scoped>/* Suas regras de estilo aqui */</style>
